return function(Window, Tabs)
    ...
    local InfoSection = Tabs.Info:AddSection("Neuro X Information", true)
...
<b>Use at your own risk!</b>
    ...
    InfoSection:AddParagraph({
        Title = "NEURO X Discord",
        Content = "Official link discord Neuro X!",
        Icon = "discord",
        ButtonText = "COPY LINK DISCORD",
        ButtonCallback = function()
            if setclipboard then
                setclipboard("https://discord.gg/uQwTApuTSa")
